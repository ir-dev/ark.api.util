...
namespace ark.net.util
{
    public class PwdPolicy
    {
        ...
        public PwdPolicy(int minLength, int maxLength, bool requireUpper,
        ...
        public PwdPolicyResult ValidatePassword(string password)
        {
            var result = new PwdPolicyResult { IsValid = true };
